...
const StatuteENMemorandumWaiverForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://script.google.com/macros/s/AKfycbzgSzcU4HZ6-LzEJYeZndGi6iUTlS3dbJ_vHb-Ea5AmPOb9SQXQMWMvIDTuxT7j6O7Tgg/exec', {
        method: 'POST',
        body: formData,
      });
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="mt-6">
            ...
            <div className="p-4 border rounded-md bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white h-48 overflow-y-scroll">
              <p className="font-bold">MEMORANDUM ON PERMISSION TO USE JURISIN COLIEE 2024 TASK PARTICIPANT DATA COLLECTION(E)</p>
              <p className="font-bold">Article 1. Description of Data</p>
              <p>1. Task Data(E) is defined as data which appears in Section 1 of the Appendix attached herein.</p>
              ...
              <p>4. Data Collection(E) consists of the Task Data(E), Raw Submission Data, Evaluation Data, Outputs of Natural Language Processing Tools, and PROLEG logic examples.</p>
              <p className="font-bold">Article 2. Retention of Rights</p>
              <p>1. The copyright holders of the Task Data(E) are defined in Section 2 of the Appendix attached herein.</p>
              <p>2. USER/USER’S RESEARCH GROUP retains all intellectual property rights relating to the technology and systems developed by USER/USER’s RESEARCH GROUP using the Data Collection(E).</p>
              <p>3. COG retains all intellectual property rights relating to analytical results obtained by COG and improvements on the Data Collection(E) and such made by COG based on data submitted by USER/USER’s RESEARCH GROUP.</p>
              <p className="font-bold">Article 3. Permission for Use</p>
              <p>COG hereby permits USER/USER’S RESEARCH GROUP to use the Data Collection(E).</p>
              <p className="font-bold">Article 4. Scope of Authorized Use</p>
              <p>1. USER/USER’S RESEARCH GROUP shall use the Data Collection(E) solely for the purpose of accomplishing task set out in the JURISIN COLIEE 2024 Workshop and for the purpose of research related to the task until and inclusive of the last day of June 2024, the end of the term of JURISIN COLIEE 2024 Workshop.</p>
              <p>2. USER/USER’S RESEARCH GROUP shall restrict that uses of the Data Collection(E) are done only by the following Research Representative and by those who belong to the organization (regardless of its name, such as “laboratory”, “group”, or “project”) that Representative is a member of, and do research jointly with Representative or are graduate students and the like Representative supervises (hereinafter referred to as “Group”).</p>
              <p className="font-bold">Research Representative:</p>
              <p>Name: Title: Affiliation:</p>
              <p>3. USER/USER’S RESEARCH GROUP shall not sell, lend, publish, distribute, or make transmittable to a third party the Data Collection(E), copies of the Data Collection(E), or processed data which would enable a third party to reproduce the Data Collection(E).</p>
              <p>4. USER/USER’S RESEARCH GROUP shall use the Data Collection(E) solely for the purpose of research related to legal information retrieval and natural language processing after the end of the term of JURISIN COLIEE 2024 workshop.</p>
              ...
              <p>COG will provide the Data Collection(E) to USER/USER’S RESEARCH GROUP using a method which is defined in Section 3 of the Appendix attached herein.</p>
              <p className="font-bold">Article 6. Presentation of Knowledge</p>
              <p>1. USER/USER’S RESEARCH GROUP may present research findings concerning knowledge obtained using the Data Collection(E) provided that the aforementioned presentation is within the limits of this Memorandum.</p>
              <p>2. USER/USER’S RESEARCH GROUP may quote in part data included in the Data Collection(E) if and only if the aforementioned data is required to describe USER/USER’S RESEARCH GROUP’s own research. In such cases, USER/USER’S RESEARCH GROUP shall not violate the rights of the authors, publishers and others protected by copyright.</p>
              ...
              <p>5. USER/USER’S RESEARCH GROUP shall submit to COG: (a) a publication report including bibliographic information of the publication (the titles of the publication, volume, pages, publishers’ names and dates), and (b) one (1) offprint or one (1) copy of the publication each time when USER/USER’S RESEARCH GROUP publishes the research results using the Data Collection(E) or part of the Data Collection(E).</p>
              <p>6. Before making public any information data developed using the Data Collection(E), USER/USER’S RESEARCH GROUP should receive consent in writing from COG in advance.</p>
              <p>7. USER/USER’S RESEARCH GROUP shall not use evaluation results obtained through use of the Data Collection(E) for profitable purposes including advertising, and/or defamatory or slanderous purposes.</p>
              ...
              <p>2. USER/USER’S RESEARCH GROUP shall submit to COG a report concerning research activities conducted by USER/USER’S RESEARCH GROUP during the duration of the Memorandum using the Data Collection(E) more than one month before the expiration date of the Memorandum.</p>
              <p className="font-bold">Article 9. Termination of Data Use</p>
              <p>1. If the use of data is deemed to be in violation of the Memorandum, USER/USER’S RESEARCH GROUP shall, upon instructions from COG, immediately discontinue use of the Data Collection(E) and promptly delete the Data Collection(E) and all data obtained by processing the Data Collection(E) from any computer or media onto which it has been copied. USER/USER’S RESEARCH GROUP shall submit a document attesting to deletion of the data to COG.</p>
              <p>2. If there is a request to discontinue the use of data from the copyright holder(s) or their executor(s) of the Data Collection(E), USER/USER’S RESEARCH GROUP must delete said data from any computer or media onto which it has been copied upon instructions from COG. USER/USER’S RESEARCH GROUP shall submit a document attesting to deletion of the data to COG.</p>
              <p className="font-bold">Article 10. Exemption from Liability</p>
              <p>COG and the copyright holder(s) or their executor(s) of the Data Collection(E) shall not for any reason whatsoever be responsible for losses arising from USER/USER’S RESEARCH GROUP’s use of the Data Collection(E).</p>
              ...
              <p>APPENDIX-JURISIN COLIEE 2024 Legal Information Entailment: Bar Exam English Data</p>
              <p>TASK PARTICIPANT DATA COLLECTION(E) (FOR JURISIN COLIEE WORKSHOP 2024 COMPETITION PARTICIPANTS)</p>
              <p className="font-bold">Section 1.</p>
              <p>The competition's formal name is JURISIN COLIEE Workshop 2024 Competition on Legal Information Extraction/Entailment: Bar Exam English Data, and the term of “Task Data(E)” consists of JURISIN COLIEE 2024 Workshop Training/Test Data written in English.</p>
              <p>2. JURISIN COLIEE 2024 Workshop Training/Test Data written in English consists of English translation of a set of queries, relevant civil law articles, and Yes/No answer of the queries that COG created using Bar Exam Data of Japan which appears in Table A, English translation of Japan Civil Law Articles provided by Japanese Law Translation Database System of Ministry of Justice in Japan, and annotations that COG assigned to the data.  The data will be available depending on the participating task.</p>
              <p>Table A</p>
              ...
              <p>COG retains derivative copyright of translations of Bar Exam Task Data. COG retains all rights under the Copyright Law relating to annotations.</p>
              <p className="font-bold">Section 3.</p>
              <p>COG will provide the Data Collection(E) to USER/USER’S RESEARCH GROUP by transferring the data files electronically.</p>
            </div>
          </div>
